...
const Display = () => {
  ...
  return (
    <section className='flex justify-center items-center border-b-[0.01vw] w-full h-full' style={styles}>
      <div className='my-20 w-[60vw] h-[40vw]'>
        <h2 class='mx-auto max-w-[900px] font-body font-semibld text-center text-green-300 text-primary-600 xl:text-[66px] leading-none'>
